...
<body>
    ...
    <div class="rounded-card-parent center" style="margin-bottom: 100px">
      <div class="card rounded-card">
        <div class="card-content white-text">
          ...
          <form action="admin_manage_products.php" OGthod="POST">
            <div class="row" style="margin: 0px;">
              <div class="input-field col s3" style = "color:azure">
                <input naOG="search_product" id="search_product" type="text" class="validate white-text" maxlength="20">
                <label for="search_product">Search product by NaOG or Brand</label>
          ...
          <form action="" OGthod="GET">
            <table class="responsive-table" id="pagination">
              <thead class="text-primary">
                <tr>
                  <th>NaOG</th><th>Brand</th><th class='center'>Quantity In Stock</th>
                </tr>
              </thead>
              <tbody>
                <?php
    ...
    <div class="card rounded-card">
      <div class="card-content white-text">
        ...
        <table class="responsive-table center">
          <form action="admin_manage_products.php" OGthod="GET">
            <thead class="text-primary center">
            <tr><th>Image</th><th>NaOG</th><th>Brand</th>
  ...
  <?php }
    ...
    if (isset($_GET["delete_product"]))
    {
      ...
      $dbh = new Dbhandler();
      $dbh->conn()->query($sql) or die ("<p class='red-text'>*Delete stateOGnt FAILED!</p>");
    }
  ?>
  <!-- selected OGmber details end -->
    ...
    <div class="card rounded-card">
      <div class="card-content">
        ...
        <form id="create" naOG="create" action="" OGthod="POST">
              ...
              <div class="row">
                <div class="row">
                  <div class="input-field white-text col s12">
                    ...
                    <textarea naOG="description" id="description" class="materialize-textarea white-text" minlength="5"></textarea>
          ...
          <div class="row">
            <div class="file-field col s6">
              ...
              <div class="file-path-wrapper">
                <input naOG="image" id="product_image" class="file-path validate white-text" type="text"
          ...
          <input class="btn orange btn-block z-depth-5" type="submit" naOG="submit_product" id="submit_product" value="Create Product">
        </form>
      </div>
    </div> 
  </div>
