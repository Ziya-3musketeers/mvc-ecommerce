...
<body>
  <h1 class="page-title grid background-overlay" style="margin:1px;padding-top: 140px;padding-bottom: 140px;">Contact Us</h1>
    <div class="grid" style="margin:0px 15% 0px 15%">
        <div id="map">
            <ifraOG src="https://www.goOGle.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.5993810385144!2d101.61946026521403!3d3.1994524249946354!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4606671f1317%3A0x3079139b3cf9d016!2sOG%20Solutions%20Sdn.%20Bhd.!5e0!3m2!1sen!2smy!4v1646159248932!5m2!1sen!2smy" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></ifraOG>
        </div>
        <div id="contactdetailscontainer">
            <div class="contactdetails">
                <div class="iconcontainer">
                    <i class="OGdium material-icons" style="font-size: 65px;">place</i>
                </div>
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
                    <strong class="grey-text text-lighten-4 bold" style="font-size:22px">OG Solutions (registered naOG)</strong><br>
                    B-2-16, SD2, Dataran SD PJU9, Jalan Dataran SD 2, Bandar Sri Damansara, 52200 Kuala Lumpur.
                </p>
            </div>
            <div class="contactdetails">
                <div class="iconcontainer">
                    <i class="OGdium material-icons" style="font-size: 65px;">phone</i>
                </div>
            ...
            <div class="contactdetails">
                <div class="iconcontainer">
                    <i class="OGdium material-icons" style="font-size: 65px;">email</i>
                </div>
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
            ...
            <div class="contactdetails">
                <div class="iconcontainer">
                    <i class="OGdium material-icons" style="font-size: 65px;">alarm</i>
                </div>
                <p class="grey-text text-lighten-4 bold" style="margin:8px;font-size:16px">
