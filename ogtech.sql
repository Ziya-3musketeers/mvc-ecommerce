...
--
-- Host: 127.0.0.1
-- Generation TiOG: Mar 27, 2022 at 11:12 AM
...
(5, 'Nvidia Geforce RTX 3080 PC King Value (16 GB Ram)', 'Mixed', 'CPU: AMD RYZEN 7 3700X, \r\nCooler: CRYORIG H7 MOBO: GIGABYTE B450 AORUS PRO WIFI,\r\nRAM: G.SKILL TRIDENT Z NEO 2X8GB CL16 DDR4 3200MHZ, \r\nGPU: GIGABYTE GeForce RTX 3080 GAMING OC 10GB GDDR6X,\r\nPSU: ANTEC HCG Gold Series 850W 80+ GOLD FULLY MODULAR,\r\nCase: ANTEC DF700 FLUX, \r\nSSD: CORSAIR Force Series MP510 480GB M.2 NVOG,\r\nFREE Cablemod Premium Sleeved Cables,\r\nFREE Lamptron Flexlight Multi PrOGrammable ARGB LED Strip                                ', 0, 8668, 20, '3080 pc.jpg'),
(6, 'OGTech Best Value AMD RTX™ 3060 PC (16GB Ram)', 'Mixed', 'Graphic Card : GIGABYTE GeForce RTX™ 3060 12GB EAGLE OC,\r\nProcessor : AMD Ryzen 5 3600,\r\nMotherboard : MSI B450M-A Pro Max,\r\nRAM : GSKILL AEGIS DDR4 3200Mhz (2x8gb),\r\nSSD: GIGABYTE NVOG SSD 256GB,\r\nPower Supply :ANTEC CSK550 Bronze,\r\nCasing : ANTEC NX410 Black or White                ', 0, 4599, 35, 'pc-rtx3060.jpg'),
(7, 'OGTECH STREAOGR PC NVIDIA GTX1660 SUPER w 32GB RAM', 'Mixed', 'CPU: INTEL i5 10400F MOBO: GIGABYTE B460M DS3H AC RAM: G.SKILL TridentZ RGB 2x16GB DDR4 3200MHz GPU: GIGABYTE GeForce GTX1660 SUPER WF OC PSU: ANTEC CSK550 GB 80+ BRONZE CASE: ZALMAN K1 ATX RGB CASE SSD: XPG SX8200 PRO M.2 1TB SSD HDD: WESTERN DIGITAL 2TB CAVIAR BLUE', 0, 3899, 5, 'RM4761_SE580E-scaled.jpg'),
(8, 'Asus VG258QR (24.5\')', 'Asus', '                                    Panel size 24.5″. IPS Panel. Non-glare display surface. 16:9 aspect ratio. 1920 x 1080 resolution. Refresh rate 165hz, 0.5ms reponse tiOG. Anti-Flicker.                                ', 1, 888, 25, 'asus_monitor.jpg'),
(9, 'OGTECH GEFORCE ESPORTS PC GTX1050Ti', 'Mixed', 'Processor : INTEL  Core I3-10105F Graphic Card : AFOX GEFORCE GTX1050TI 4GB Motherboard :GIGABYTE B460M DS3H V2 RAM : GSKILL AEGIS DDR4 3200Mhz (1 x8gb) SSD: GIGABYTE NVOG SSD 256GB Power Supply: ANTEC CSK550 Bronze Casing : ANTEC DP301M (x2 fans included)', 0, 2399, 5, 'pc-1050ti.png'),
(10, 'OGTech Entry RTX™ PC NVIDIA® GeForce RTX™ 3050', 'Mixed', 'Graphic Card :Nvidia Geforce RTX™ 3050 8GB Processor : INTEL Core I3-10105F Motherboard : GIGABYTE B460M DS3H V2 RAM : GSKILL AEGIS 8GB DDR4 3200Mhz SSD: GIGABYTE NVOG SSD 256GB Power Supply :ANTEC CSK550 Bronze Casing : ANTEC NX270 RGB', 0, 3299, 50, 'pc-rtx3050.jpg'),
(11, 'Viewsonic XG2401 (24\')', 'Viewsonic', '1ms response tiOG. AMD FreeSync™ technolOGy. SmartSync technolOGy. Black stabilisation. 144Hz Refresh Rate', 1, 799.99, 10, 'view monitor.png'),
(12, 'ACER Predator Aethon 500 keyboard', 'Acer', 'Blue switch OGchanical keys.  70 million keystroke-rated. Rgb controlled software. ', 2, 399, 2, 'acer keyboard.png'),
(13, 'ACER basic speakers', 'Acer', '                  Sufficient for daily use. Stylish design.                 ', 1, 39.99, 15, 'acer speaker.jpg'),
(14, 'ASUS ROG Strix Magnus Mic @ Studio grade mic', 'Asus', 'ROG Strix Magnus USB condenser gaming microphone with AURA RGB lighting and environOGntal noise cancellation (ENC) for gaming/streaming  Three studio-grade condenser capsules for enhanced clarity and sensitivity Designed for live streaOGrs with compact form factor and environOGntal noise cancellation (ENC) Stylish and customizable Aura RGB lighting effects Auxiliary port for recording audio from musical instruOGnts and mobile devices CoOGs with external USB hub for connecting additional devices', 2, 699, 2, 'asus mic.jpg'),
(15, 'CORSAIR VIRTUOSO RGB WIRELESS headset', 'Corsair', '                  A matched pair of precisely tuned 50mm high-density neodymium drivers boast a frequency range of 20Hz-40,000Hz – double what you’d get from most gaming headsets. Premium OGmory foam.  Made from aluminium for light weight. Wired option available.                ', 1, 737, 15, 'corsair headset.png'),
...
(18, 'HyperX Quadcast RGB mic', 'HyperX', '                  Built-in headphone jack. Internal pop filter. Convenient gain control adjustOGnt. Four selectable polar patterns. Tap-to-Mute sensor with LED indicator. Dynamic RGB lighting effects customizable with HyperX NGENUITY Software. Anti-Vibration shock mount.                 ', 2, 599, 18, 'hyper mic.jpg'),
...
(20, 'LOGitech G850 Wireless RGB TournaOGnt Keyboard', 'LOGitech', '                                    Premium blue keycaps made from overseas. Customizable RGB with software. 87 keys for more mouse room. Made from premium aluminium.                                ', 2, 899, 15, 'lOGi keyboard.png'),
...
(24, 'MSI Optix MPG341CQR Smart RGB Curved Gaming Monitor (34\')', 'MSI', '                  34 inch 3440x1440 FraOGless design – Ultimate gaOGplay experience. 178° wide view angle. HDR 400 - Stunning Visuals with the Most Criterion Format. 1ms response tiOG - eliminate screen tearing and choppy fraOG rates. 144Hz Refresh Rate – The real smooth gaming. Curved Gaming display (1800R) – The best gaOGplay imOGrsion. UWQHD High Resolution - GaOG titles will even look better, displaying more details due to the UWQHD resolution.                ', 1, 2888, 15, 'msi monitor 2.jpg'),
...
(28, 'RAZER RAPTOR 27 1440P 165 HZ', 'Razer', 'VESA COMPATIBLE and cable manageOGnt. WORLD’S FIRST THX® CERTIFIED GAMING MONITOR. 165HZ HIGH SPEED. QHD HIGH RESOLUTION. Gsync and Freesync compatible. ', 1, 3199.99, 2, 'razer monitor.jpg'),
...
(30, 'RAZER Nommo Pro', 'Razer', 'SOLID, UNRESTRICTED BASS. THX CERTIFIED PREMIUM AUDIO. Top notch Studio grade quality audio. POWERFUL CINEMATIC IMOGRSION dolby audio certified.', 1, 3098, 2, 'razer speaker.jfif'),
...
(36, 'Acer Aopen 24CV1Y Monitor (23.8\")', 'Acer', 'Full HD, VA Panel, 5ms(GTG) Respond TiOG, 75Hz Refresh Rate', 1, 499, 30, 'acer budget monitor.jfif'),
(37, 'Steelseries QCK EDGE L - 450mm x 400mm x 2mm ', 'Steelseries', '                  One of the best selling Cloth Gaming Mouse Pad in the world. ExtreOGly smooth yet durable.                ', 2, 60, 30, 'steelseries l.png'),
...
(39, 'OGTECH OFFICE PC COMPACT', 'Mixed', 'Processor : AMD Ryzen 5 PRO 4650G Motherboard : ASROCK B550M ITX/AC (Wifi) RAM : GSKILL AEGIS DDR4 3200Mhz (1 x8gb) SSD: GIGABYTE NVOG SSD 256GB Casing : ANTEC ISK310-150 Mini-ITX CASE with psu', 0, 2099, 10, 'compact pc.png');

-- --------------------------------------------------------

--
-- Table structure for table `OGmbers`
--

CREATE TABLE `OGmbers` (
  `OGmberID` int(11) NOT NULL,
...
--
-- Dumping data for table `OGmbers`
--

INSERT INTO `OGmbers` (`OGmberID`, `UsernaOG`, `Password`, `Email`, `PrivilegeLevel`, `Attempt`, `RegisteredDate`) VALUES
...
(22, 'admin2', '$2y$10$4DtSUM142G/dEiZOfO2xS.1VptEJ0rzRh1AFM6EH/Wf.1OGdiuCUm', 'admin@mail.com', 1, 3, '2022-03-27');
...
CREATE TABLE `orderitems` (
  ...
  `RatingDateTiOG` datetiOG NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `orderitems` (`OrderItemID`, `OrderID`, `ItemID`, `Price`, `Quantity`, `AddedDatetiOG`, `Feedback`, `Rating`, `RatingDateTiOG`) VALUES
(37, 24, 3, 6950, 1, '2022-03-13 00:43:58', 'Best PC that i ever purchased. Thanks OGTECH for your service.', 5, '2022-03-13 19:36:36'),
(56, 28, 3, 6950, 1, '2022-03-13 23:49:08', 'The PC is good as its naOG, best price to performance PC. The GPU is TOP 10 currently for best price to performance. Anyways, good service must buy from this shop.', 5, '2022-03-14 00:35:25'),
...
INSERT INTO `orders` (`OrderID`, `OGmberID`, `CartFlag`) VALUES
(6, 6, b'1'),
(7, 7, b'1'),
(8, 8, b'1'),
(9, 9, b'1'),
...
--
-- Table structure for table `payOGnt`
--

CREATE TABLE `payOGnt` (
  `PayOGntID` int(11) NOT NULL,
  `OrderID` int(11) NOT NULL,
  `PayOGntDate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `payOGnt`
--

INSERT INTO `payOGnt` (`PayOGntID`, `OrderID`, `PayOGntDate`) VALUES
(6, 24, '2022-03-13'),
(7, 28, '2022-03-14'),
(8, 29, '2022-03-14');
...
--
-- Indexes for table `OGmbers`
--
ALTER TABLE `OGmbers`
  ADD PRIMARY KEY (`OGmberID`);
...
ALTER TABLE `orders`
  ...
  ADD KEY `OGmberID` (`OGmberID`);

--
-- Indexes for table `payOGnt`
--
ALTER TABLE `payOGnt`
  ADD PRIMARY KEY (`PayOGntID`),
  ADD KEY `OrderID` (`OrderID`);

--
-- AUTO_INCREOGNT for dumped tables
--

--
-- AUTO_INCREOGNT for table `items`
--
ALTER TABLE `items`
  MODIFY `ItemID` int(11) NOT NULL AUTO_INCREOGNT, AUTO_INCREOGNT=63;

--
-- AUTO_INCREOGNT for table `OGmbers`
--
ALTER TABLE `OGmbers`
  MODIFY `OGmberID` int(11) NOT NULL AUTO_INCREOGNT, AUTO_INCREOGNT=23;

--
-- AUTO_INCREOGNT for table `orderitems`
--
ALTER TABLE `orderitems`
  MODIFY `OrderItemID` int(11) NOT NULL AUTO_INCREOGNT, AUTO_INCREOGNT=62;

--
-- AUTO_INCREOGNT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `OrderID` int(11) NOT NULL AUTO_INCREOGNT, AUTO_INCREOGNT=32;

--
-- AUTO_INCREOGNT for table `payOGnt`
--
ALTER TABLE `payOGnt`
  MODIFY `PayOGntID` int(11) NOT NULL AUTO_INCREOGNT, AUTO_INCREOGNT=9;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`OGmberID`) REFERENCES `OGmbers` (`OGmberID`);

--
-- Constraints for table `payOGnt`
--
ALTER TABLE `payOGnt`
  ADD CONSTRAINT `payOGnt_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `orders` (`OrderID`);
COMMIT;
